...
part 'select_file_vacation_state.dart';

class SelectFileVacationCubit extends Cubit<SelectFileVacationState> {
  SelectFileVacationCubit() : super(RequestVacationInitial());
  File? selectedFile;
  String? fileName;
  File? fileSize;
